def call(String name = 'jenkins') {
    node {
        ...
        def branch = 'dev'
        def tag = ''
        def gitURL = 'github.com/gianglt2198/cicd.git'
        try {
            docker.withRegistry('', 'docker-hub') {
                ...
                stage('CHECKOUT') {
                    withCredentials([usernamePassword(credentialsId: "github-gianglt2198", passwordVariable: 'GIT_PASSWORD', usernameVariable: 'GIT_USERNAME')]) {
